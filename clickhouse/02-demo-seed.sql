...
INSERT INTO bionicpro.emg_sensor_data (customer_id, prosthesis_id, prosthesis_type, muscle_group, signal_frequency, signal_duration, signal_amplitude, signal_time) VALUES (1, 'arm-001', 'arm', 'biceps', 180, 950, 2.450, now() - INTERVAL 47 HOUR), (1, 'arm-001', 'arm', 'triceps', 205, 870, 2.810, now() - INTERVAL 30 HOUR), (1, 'arm-001', 'arm', 'biceps', 198, 910, 2.670, now() - INTERVAL 20 HOUR), (2, 'hand-002', 'hand', 'forearm', 220, 740, 3.110, now() - INTERVAL 44 HOUR), (2, 'hand-002', 'hand', 'forearm', 215, 760, 3.050, now() - INTERVAL 18 HOUR), (3, 'leg-003', 'leg', 'quadriceps', 160, 1100, 2.220, now() - INTERVAL 28 HOUR);
